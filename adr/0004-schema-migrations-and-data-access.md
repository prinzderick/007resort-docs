# ADR-0004: Versioned SQL migrations owned by otueke-api; EF Core + Dapper split for data access
...
- Contributors need to be comfortable writing SQL directly for schema changes and for the contention-critical statements; this is called out in `otueke-api/CONTRIBUTING.md`.
- The migration review is a required step in every pull request that touches `db/migrations/` ([`otueke-api` PR template](https://github.com/prinzderick/otueke-api)).
